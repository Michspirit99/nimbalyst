...
interface ElectronAPI {
  ...
  aiCreateSession: (provider: 'claude' | 'claude-code' | 'claude-code-cli' | 'openai' | 'openai-codex' | 'opencode' | 'copilot-cli' | 'lmstudio' | 'synthetic', documentContext?: any, workspacePath?: string, modelId?: string, sessionType?: string, worktreeId?: string) => Promise<any>;
  ...
  testAIConnection: (provider: 'claude' | 'claude-code' | 'openai' | 'lmstudio' | 'synthetic') => Promise<any>;
  ...
  ai: {
    ...
    createSession: (provider: 'claude' | 'claude-code' | 'claude-code-cli' | 'openai' | 'openai-codex' | 'lmstudio' | 'synthetic', documentContext?: any, workspacePath?: string, modelId?: string, sessionType?: string, worktreeId?: string) => Promise<any>;
