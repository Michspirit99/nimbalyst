...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  aiCreateSession: (provider: 'claude' | 'claude-code' | 'claude-code-cli' | 'openai' | 'openai-codex' | 'opencode' | 'copilot-cli' | 'lmstudio' | 'synthetic', documentContext?: any, workspacePath?: string, modelId?: string, sessionType?: string, worktreeId?: string) => {
  ...
  testAIConnection: (provider: 'claude' | 'claude-code' | 'openai' | 'lmstudio' | 'synthetic') => ipcRenderer.invoke('ai:testConnection', provider),
  ...
  ai: {
    ...
    createSession: (provider: 'claude' | 'claude-code' | 'claude-code-cli' | 'openai' | 'openai-codex' | 'lmstudio' | 'synthetic', documentContext?: any, workspacePath?: string, modelId?: string, sessionType?: string, worktreeId?: string) =>
